...
export const DEFAULT_COORDINATES: CoordinatesConfig = {
  ...
  fields: {
    ...
    fan: {
      id: 'fan',
      label: 'FAN Card Number (Separated)',
      side: 'front',
      x: 415,
      y: 555,
      fontSize: 28,
    ...
    frontBarcodeSeparate: {
      id: 'frontBarcodeSeparate',
      label: 'Front Barcode (Separated)',
      side: 'front',
      x: 415,
      y: 595,
      fontSize: 12,
    ...
    barcodeText: {
      id: 'barcodeText',
      label: 'FIN Code (Bottom Left Box) - Layer',
      side: 'back',
      x: 65,
      y: 545,
      fontSize: 20,
  ...
  media: {
    photoFront: {
      id: 'photoFront',
      label: 'Front Applicant Primary Photo (Large)',
      side: 'front',
      x: 45,
      y: 145,
      width: 280,
    ...
    photoFrontSecondary: {
      ...
      label: 'Second Photo (Small - Bottom Right Security Portrait)',
      side: 'front',
      x: 825,
      y: 435,
      width: 145,
    ...
    frontBarcode: {
      id: 'frontBarcode',
      label: 'Front FAN Barcode Strip (Separated)',
      side: 'front',
      x: 370,
      y: 590,
      width: 280,
    ...
    finLayer: {
      id: 'finLayer',
      label: 'Back FIN Layer (Droppable Image - Not Text)',
      side: 'back',
      x: 25,
      y: 515,
      width: 300,
...
export const PRESET_TEMPLATES: TemplatePreset[] = [
  ...
  },
  {
    id: 'emerald_security',
    name: 'Template 5',
    description: 'Template 5 - Emerald micro-mesh security pattern with crisp dual-side digital alignment.',
    themeColor: '#059669',
    badge: 'Template 5',
    config: {
      sourceType: 'preset',
      presetId: 'emerald_security',
  ...
  },
  {
    id: 'enterprise_dark',
    name: 'Template 6',
    description: 'Template 6 - National ID Enterprise deep-slate security weave with high-contrast biometric QR layout.',
    themeColor: '#1e293b',
    badge: 'Template 6',
    config: {
      sourceType: 'preset',
      presetId: 'enterprise_dark',
